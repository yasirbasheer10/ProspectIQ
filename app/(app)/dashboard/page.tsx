  ...
  try {
    ...
    return (
      <div className="p-10 text-red-500 font-mono bg-white h-screen">
        <h1 className="text-2xl font-bold mb-4">Fatal Dashboard Error on Vercel</h1>
        <p className="font-bold">{error.message}</p>
        <pre className="mt-4 whitespace-pre-wrap text-sm">{error.stack}</pre>
        <p className="mt-8 text-black">If this says "Database Access Denied", check your Vercel Postgres Environment Variables.</p>
      </div>
    );
  }
}
